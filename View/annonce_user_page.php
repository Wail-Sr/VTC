                ...
                <div class="container-ed">
                    ...
                    <form action="'.$this->update_an($_GET['id_annonce']).'" method="POST" enctype="multipart/form-data" class="insc-info">
                        ...
                        <div class="title">
                            ...
                            <input type="text" name="title" class="input-css" value="'.$annonce["Title"].'" placeholder="Entrez le titre dannonce ici" required>
                        </div>
                        <div class="description">
                            <label for="">Description</label><br>
                            <textarea type="text" name="description" class="input-css" placeholder="Ajouter une description..." required style="padding-top:8px; min-height:20vh">'.$annonce["Description"].'</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <select class="select-box" name="moyen" required>
