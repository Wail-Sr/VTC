                            ...
                            <div class="container-fluid">
                                <div class="mb-npx">
                                    ...
                                    <ul class="nav nav-tabs mt-4 overflow-x border-0">
                                        ...
                                        <li class="nav-item">
                                            <a href="admin_ann_d.php" class="nav-link active">Demande validation</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="admin_ann_ar.php" class="nav-link font-regular">Archivées</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            foreach($annonces as $annonce){
                                                if ($annonce["etat"] == "non_valide") echo '<tr>
