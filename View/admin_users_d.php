...
class admin_users{
  ...
  public function main(){
      try {
          $users = $this->ac->get_users_d_controller();
                            ...
                            <div class="container-fluid">
                                <div class="mb-npx">
                                    ...
                                    <ul class="nav nav-tabs mt-4 overflow-x border-0">
                                        <li class="nav-item ">
                                            <a href="admin_users.php" class="nav-link  font-regular">Tous</a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="admin_users_d.php" class="nav-link active">Demande validation</a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                        ...
                                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                            ...
                                            foreach($users as $user){
                                                echo '<tr>
                                                        ...
                                                        <td>'.$user["Email"].'</td>
                                                        <td class="col-mt5">
                                                            <a href="admin_user_edit.php?id_user='.$user["Id_user"].'" class="btn btn-sm btn-neutral">Edit</a>
                                                                <a href="admin_user_delete.php?id_user='.$user["Id_user"].'"><button type="button" class="btn btn-sm btn-square btn-neutral text-danger-hover">
