...
class admin_users{
                    ...
                    <!-- Main content -->
                        <div class="h-screen flex-grow-1 overflow-y-lg-auto">
                                ...
                                <div class="container-fluid">
                                    <div class="mb-npx">
                                        ...
                                        <ul class="nav nav-tabs mt-4 overflow-x border-0">
                                            <li class="nav-item ">
                                                <a href="admin_add_user.php" class="nav-link active">Client</a>
                                            </li>
                                            <li class="nav-item">
                                                <a href="admin_add_user_t.php" class="nav-link font-regular">Transporteur</a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                            ...
                            <div class="card mb-4">
                                ...
                                <div class="card-body">
                                    <form action="'.$this->admin_add_user().'" method="POST">
                                        <!-- Form Row-->
  ...
  public function admin_add_user(){
    ...
    {    
        ...
        $this->ac->admin_add_user_controller("client", $first, $last, $mobile, $adress, $email, $password);
